...
class SobreController extends Controller
{
    public function __invoke()
    {
        $meta = [
            ...
            <meta name="description" content="Desvalorização é uma ferramenta que te ajuda a entender os efeitos da inflação sobre o poder de compra da população brasileira. Usando os Índices IPCA (Índice de preços para consumidor amplo) e INPC (Índice Nacional de Preços ao Consumidor), monta-se um panorama da desvalorização do real no decorrer dos anos. Dessa forma, é mostrado valores de alguns produtos em determinadas épocas e seus respectivos valores junto aos dados dá inflação. Portando, é esperado que o usuário entenda como a inflação afeta-o diretamente." />
